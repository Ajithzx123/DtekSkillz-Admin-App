    ...
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider<SectionCubit>(
            create: (final _) => SectionCubit(SectionRepository())),
        ...
        BlocProvider<ProviderDetailsAndServiceCubit>(
          create: (final _) => ProviderDetailsAndServiceCubit(
        ...
        BlocProvider(
          create: (final context) => VerifyPhoneNumberFromAPICubit(
          ...
          return BlocBuilder<LanguageCubit, LanguageState>(
            builder: (final BuildContext context,
              ...
              child: MaterialApp(
                ...
                builder: (final context, final widget) => ScrollConfiguration(
