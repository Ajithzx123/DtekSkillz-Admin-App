...
class Api {
  ...
  //AAA
  static String searchUser = "${baseUrl}get_client_service";
  static String updateUser = "${baseUrl}update_user";
  //AAA new url
  // static String updateUser1 = "${baseUrl1}update_user";
  ...
  ///AAA
  static String taxlist = "${baseUrl1}get_taxes";
  ...
  static const String noOfYears = "no_of_year_industry";
  static const String typeOfServices = "type_of_service";
