...
class _ScheduleScreenState extends State<ScheduleScreen> with ChangeNotifier {
  ...
  Widget getServiceDeliverableOptions() {
    return
        ...
        //                 children: [
        //                   Text(
        //                     deliverableOptions[index]["title"]!
        //                         .translate(context: context),
        //                     style: const TextStyle(fontSize: 14),
        //                   ),
        //                   Text(
        //                     deliverableOptions[index]["description"]!
        //                         .translate(context: context),
        //                     style: TextStyle(
        //                       fontSize: 12,
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderSide: BorderSide(
                color: Theme.of(context).colorScheme.secondaryColor, width: 2),
            borderRadius: BorderRadius.circular(10),
          ),
          focusedBorder: OutlineInputBorder(
            borderSide:
                BorderSide(color: Theme.of(context).colorScheme.secondaryColor),
            borderRadius: BorderRadius.circular(10),
          ),
        ),
      );
                ...
                if (getAddressState.data.isNotEmpty) {
                  if (getAddressState.data[0].id != null) {
                    getAddressState.data
                        .insert(0, GetAddressModel.fromJson({}));
                  }
                }
  ...
  Widget continueButtonContainer(final BuildContext context) => BlocConsumer<
