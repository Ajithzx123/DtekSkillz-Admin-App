...
class _OrderSummeryScreenState extends State<OrderSummeryScreen> {
  ...
  late final List<Map<String, String>> paymentMethods = [
    {
      ...
      "atStoreDescription": "payOnlineNow"
    },
    // {
    //   "title": 'payOnService',
  ...
  Future<void> openPaystackPaymentGateway({
    ...
    final CheckoutResponse response = await payStackPaymentGateway.checkout(
      context,
      logo:
          SvgPicture.asset("$imagePath/splash_logo.svg", width: 50, height: 50),
...
// gettax Item
  Future<Map<String, dynamic>> getTaxList() async {
    try {
  ...
  void getProviderId() {
    Future.delayed(Duration.zero).then((final value) =>
        providerId = context.read<CartCubit>().getProviderIDFromCartData());
  }
              ...
              children: [
                SingleChildScrollView(
                  padding: EdgeInsets.only(
                      bottom: UiUtils.bottomNavigationBarHeight + 20),
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            customOrderSummeryTile(
                              context,
                              title:
                                  widget.selectedDate.toString().formatDate(),
                              subtitle:
                                  widget.selectedTime.toString().formatTime(),
                              isMultipleText: true,
                              leadingIcon: UiUtils.getSvgImage(
                            ...
                            CustomInkWellContainer(
                              ...
                              child: customOrderSummeryTile(
                                context,
                                title:
                                    "applyCoupon".translate(context: context),
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: List.generate(
                                    ...
                                    context.read<CartCubit>().isPayLaterAllowed(
                                                isFrom: widget.isFrom) ==
                                            '1'
                                ...
                                children: [
                                  ListView.builder(
                                    ...
                                    itemBuilder: (final context, index) {
                                      final cartDetails = widget.isFrom ==
                                              "cart"
                                      ...
                                      if (taxlist.isEmpty) {
                                        ...
                                        final String taxId = cartDetails
                                                ?.serviceDetails!.taxId ??
                                            '0.0';
                                        var currentTaxValue =
                                            taxlist.firstWhere((element) =>
                                                element['id'] == taxId);
                                        print(currentTaxValue);
                                        final String percentage =
                                            currentTaxValue['percentage'];
                                        print(percentage);

                                        final String price = cartDetails
                                                ?.serviceDetails!.price ??
                                            "0.0";
                                        print(price);
                                        taxAmount = double.parse(price) *
                                  ...
                                  if (promoCodeDiscount != 0.0)
                                    chargesTile(
                                      ...
                                      title2: '',
                                      title3:
                                          '- ${UiUtils.getPriceFormat(context, promoCodeDiscount.toString())}',
                                      fontSize: 14,
                                    ),
                                  const SizedBox(
                                    height: 5,
                                  ...
                                  if (widget.isFrom == "cart" &&
                                    ...
                                    chargesTile(
                                      ...
                                      title2: '',
                                      title3:
                                          '+ ${UiUtils.getPriceFormat(context, state.cartData.visitingCharges!)}',
                                      fontSize: 14,
                                    ),
                                  if (widget.isFrom == "reOrder" &&
                                    ...
                                    chargesTile(
                                      ...
                                      title2: '',
                                      title3:
                                          '+ ${UiUtils.getPriceFormat(context, state.reOrderCartData?.visitingCharges ?? "0")}',
                                      fontSize: 14,
                                    ),
                                  const Divider(),
                                  chargesTile(
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    child: BlocConsumer<PlaceOrderCubit, PlaceOrderState>(
                      listener:
                          (final BuildContext context, PlaceOrderState state) {
                        if (state is PlaceOrderSuccess) {
                          if (!state.isError) {
                            ...
                            if (selectedPaymentMethod == "payOnService") {
                              ...
                              if (paymentGatewaySetting!.stripeStatus ==
                                  "enable") {
                                //
                                ...
                                openPaystackPaymentGateway(
                                  orderAmount: cartTotalAmount,
                                  emailId: Hive.box(userDetailBoxKey)
                                          .get(emailIdKey) ??
                                      "test@gmail.com",
                                  placedOrderId: state.orderId,
                                );
                              } else if (paymentGatewaySetting!.paypalStatus ==
                                  "enable") {
                                //
                                Navigator.pushNamed(
                                  context,
                                  ...
                                  final parameter = value as Map;
                                  if (parameter['paymentStatus'] ==
                                      'Completed') {
                                    //
                                    navigateToOrderConfirmation(
                                        isSuccess: true);
                                    //
                                  } else if (parameter['paymentStatus'] ==
                                      'Failed') {
                                    navigateToOrderConfirmation(
                                        isSuccess: false);
                                  }
                        ...
                        return ValueListenableBuilder(
                          ...
                          builder: (context, value, _) {
                            return CustomRoundedButton(
                              ...
                              backgroundColor:
                                  Theme.of(context).colorScheme.accentColor,
                              buttonTitle: selectedPaymentMethod ==
                                      "payOnService"
