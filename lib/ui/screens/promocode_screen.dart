...
//
            ...
            getMessageContainer(
              message:
                  "${'offerIsApplicableOnMinimumValueOf'.translate(context: context)} ${UiUtils.getPriceFormat(context, promoCodeDetails.minimumOrderAmount!)}",
            ),
            getMessageContainer(
              message:
                  "${'maximumInstantDiscountOf'.translate(context: context)} ${UiUtils.getPriceFormat(context, promoCodeDetails.maxDiscountAmount!)}",
            ),
            getMessageContainer(
              message:
