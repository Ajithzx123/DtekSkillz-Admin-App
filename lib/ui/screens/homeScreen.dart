...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> checkLocationPermission() async {
    ...
    if (permission == LocationPermission.always || permission == LocationPermission.whileInUse) {
      ...
      if (userDetailBox.get(latitudeKey) != null && userDetailBox.get(longitudeKey) != null) {
        final latitude = userDetailBox.get(latitudeKey);
        final longitude = userDetailBox.get(longitudeKey);
          ...
          child: Scaffold(
            ...
            body: Stack(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(bottom: UiUtils.bottomNavigationBarHeight),
  ...
  Widget _getCategoryTextContainer() => Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            // UiUtils.getSvgImage(svgImage: 'arrow_forward.svg')
          ],
        ),
      );
                ...
                children: List.generate(
                  ...
                  (final int index) => Column(
                    children: [
                      ...
                      ShimmerLoadingContainer(
                        child: _getTitleShimmerEffect(width: 75, height: 10, borderRadius: 10),
                      )
                    ],
                  ),
                ),
