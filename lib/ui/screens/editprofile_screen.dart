        ...
        builder: (final BuildContext context) {
          ...
          return EditProfileScreen(
            ...
            phoneNumberWithCountryCode:
                arguments['phoneNumberWithCountryCode'] ?? '',
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  final TextEditingController industryController =
      TextEditingController(text: Hive.box(userDetailBoxKey).get(industrykey));
  final TextEditingController divisionController =
      TextEditingController(text: Hive.box(userDetailBoxKey).get(divisionkey));
  final TextEditingController noOfyearsController =
      TextEditingController(text: Hive.box(userDetailBoxKey).get(noOfYearskey));
  final TextEditingController typeOfServiceController = TextEditingController(
      text: Hive.box(userDetailBoxKey).get(typeOfServiceskey));
  ...
  void dispose() {
    ...
    typeOfServiceController.dispose();
    super.dispose();
  }
            ...
            child: BlocConsumer<UpdateUserCubit, UpdateUserState>(
              listener: (context, UpdateUserState updateUserState) {
                if (updateUserState is UpdateUserSuccess) {
                  ...
                  final newUserDetails = existingUserDetails
                      .fromMapCopyWith(updateUserState.updatedDetails.toMap());

                  context
                      .read<UserDetailsCubit>()
                      .changeUserDetails(newUserDetails);

                  print(newUserDetails.division);
                }
              },
              builder: (final context, UpdateUserState updateUserState) =>
                ...
                children: [
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          InputFieldEditProfile(
                            hint: "Industry".translate(context: context),
                            controller: industryController,
                          ),
                          InputFieldEditProfile(
                            hint: "Division".translate(context: context),
                            controller: divisionController,
                          ),
                          InputFieldEditProfile(
                            textInputType: TextInputType.number,
                            hint: "No of Years in Industry"
                                .translate(context: context),
                            controller: noOfyearsController,
                          ),
                          InputFieldEditProfile(
                            hint:
                                "Type of Services".translate(context: context),
                  ...
                  BlocConsumer<UpdateUserCubit, UpdateUserState>(
                    ...
                    builder:
                        (final BuildContext context, UpdateUserState state) {
                      Widget? child;
                      ...
                      return SizedBox(
                        ...
                        child: CustomRoundedButton(
                          onTap: () async {
                            ...
                            if (industryController.value.text.trim().isEmpty) {
                              UiUtils.showMessage(
                                context,
                                "pleaseEnterIndustry"
                                    .translate(context: context),
                            ...
                            if (divisionController.value.text.trim().isEmpty) {
                              UiUtils.showMessage(
                                context,
                                "pleaseEnterDivision"
                                    .translate(context: context),
                            ...
                            if (noOfyearsController.value.text.trim().isEmpty) {
                              UiUtils.showMessage(
                                context,
                                "pleaseEnter Number of Years"
                                    .translate(context: context),
                                MessageType.error,
                              );
                            ...
                            if (typeOfServiceController.value.text
                                .trim()
                                .isEmpty) {
                              UiUtils.showMessage(
                                context,
                                "pleaseEnter Type of Service"
                                    .translate(context: context),
                                MessageType.error,
                              );
                            ...
                            if (Routes.previousRoute == otpVerificationRoute) {
                              final latitude =
                                  Hive.box(userDetailBoxKey).get(latitudeKey) ??
                                      "0.0";
                              final longitude = Hive.box(userDetailBoxKey)
                                      .get(longitudeKey) ??
                                  "0.0";
                              ...
                              await AuthenticationRepository.loginUser(
                                ...
                                (final UserDetailsModel value) async {
                                  ...
                                  final UpdateUserDetails updateUserDetails =
                                    ...
                                    phone: Hive.box(userDetailBoxKey)
                                        .get(phoneNumberKey),
                                    countryCode: Hive.box(userDetailBoxKey)
                                        .get(countryCodeKey),
                                    ...
                                    noOfYears: noOfyearsController.value.text,
                                    typeOfServices:
                                        typeOfServiceController.value.text,
                                  );
                                  //
                                  await context
                          ...
                          buttonTitle:
                              "saveChanges".translate(context: context),
                          backgroundColor:
