...
import 'package:e_demand/ui/screens/bookings_details/widgets/cancelAndRescheduleBookingButton.dart';
import 'package:e_demand/ui/screens/bookings_details/widgets/downloadInvoiceButton.dart';
import 'package:e_demand/ui/screens/bookings_details/widgets/reOrderButton.dart';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Spacer(),
              Text(
                UiUtils.getPriceFormat(context, price),
                style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      "${servicesList[index].quantity} x ${UiUtils.getPriceFormat(context, servicesList[index].discountPrice != "0" ? servicesList[index].discountPrice.toString() : servicesList[index].price.toString())}",
                      style: TextStyle(color: Theme.of(context).colorScheme.lightGreyColor),
                    ),
                    const Spacer(),
                    Text(
                      UiUtils.getPriceFormat(context, totalPriceOfService.toString()),
                      style: TextStyle(color: Theme.of(context).colorScheme.lightGreyColor),
                    ),
                  ],
                ),
      ...
      child: Column(
        children: [
          _getPriceSectionTile(
            ...
            subHeading: UiUtils.getPriceFormat(context, subTotal),
          ...
          if (promoCodeName != "" && promoCodeAmount != "")
            _getPriceSectionTile(
              ...
              subHeading: UiUtils.getPriceFormat(context, promoCodeAmount),
              textColor: Theme.of(context).colorScheme.blackColor,
            ),
          if (taxAmount != "")
            _getPriceSectionTile(
              ...
              subHeading: UiUtils.getPriceFormat(context, taxAmount),
              textColor: Theme.of(context).colorScheme.blackColor,
            ),
          if (visitingCharge != '0' &&
              visitingCharge != "" &&
            ...
            _getPriceSectionTile(
              ...
              subHeading: UiUtils.getPriceFormat(context, visitingCharge),
              textColor: Theme.of(context).colorScheme.blackColor,
            ),
          _getPriceSectionTile(
            context: context,
            ...
            subHeading: UiUtils.getPriceFormat(context, totalAmount),
            textColor: Theme.of(context).colorScheme.blackColor,
            fontWeight: FontWeight.bold,
          ),
        ],
